...
public interface UserCourseProgressRepository extends JpaRepository<UserCourseProgress, Long> {
    ...
    List<UserCourseProgress> findByUserAndCourseModule(@Param("user") User user, @Param("module") Module module);
    ...
    long countByUserAndCourseModuleAndCompletedTrue(@Param("user") User user, @Param("module") Module module);
